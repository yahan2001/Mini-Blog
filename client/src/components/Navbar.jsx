...
const Navbar = () => {
  ...
  const {navigate,token} = useAppContext(); // su dung hook useAppContext de lay gia tri navigate va token tu context de dieu huong nguoi dung va kiem tra trang thai dang nhap
  return (
